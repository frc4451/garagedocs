...
lessonId: tunable-constants-and-characterization
section: frc
...
<Sources items={[
  {"source": "mantik", "path": "src/content/frc/frc-control-theory/tunable-constants.mdx", "note": "The lesson's topic and original outline come from Mantik's page of the same name; the text was rewritten for GarageDocs."},
...
<LinkGrid links={[{"label":"PID Control","id":"pid-control"},{"label":"Feedforward","id":"feedforward"},{"label":"PID Tuning Practice","id":"pid-tuning-practice-setup"},{"label":"AdvantageScope","id":"reading-a-match-log"},{"label":"WPILib System Identification","url":"https://docs.wpilib.org/en/stable/docs/software/advanced-controls/system-identification/index.html"}]} title="Resources" section="frc" />
