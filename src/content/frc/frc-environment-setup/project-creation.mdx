...
difficulty: beginner
duration: 30 min
description: "Creating a Timed Robot or Command Robot project from the WPILib palette, step by step, and what each template's files are for."
durationFixed: true
---

### Create the robot project
...
<Sources items={[
  ...
  {"source": "wpilib", "path": "docs/software/vscode-overview/creating-robot-program.html", "note": "The Create a New Project dialog and templates."},
  {"source": "wpilib", "path": "docs/software/vscode-overview/wpilib-commands-vscode.html", "note": "The WPILib commands in the palette."},
  {"source": "wpilib", "path": "docs/software/vscode-overview/deploying-robot-code.html", "note": "Deploying."},
  {"source": "wpilib", "path": "docs/software/commandbased/structuring-command-based-project.html", "note": "What the command-based template generates."},
  {"source": "cobra", "path": "src/main/java/frc/robot/Main.java", "note": "The entry point the template generates."},
  {"source": "cobra", "path": "src/main/java/frc/robot/Robot.java", "note": "The lifecycle methods of the generated <code>Robot.java</code>."}
]} />
