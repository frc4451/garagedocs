---
title: "Command-Based Intake"
lessonId: command-based-intake
section: frc
...
<LinkGrid links={[{"label":"Introduction to Command-Based","id":"introduction-to-command-based"},{"label":"PID Control","id":"pid-control"}]} title="Resources" section="frc" />
