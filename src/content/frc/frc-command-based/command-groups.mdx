...
Sequencing was [Kit Bot R14](/kit-bot/r14-time-based-autonomous): `Commands.sequence`, `waitSeconds`, a chooser. This lesson covers the full composition vocabulary (parallel, race, deadline, `until`, `finallyDo`) as Cobra's scoring sequences use it.
