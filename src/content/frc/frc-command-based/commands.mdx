...
<Sources items={[
  {"source": "mantik", "path": "src/content/frc/frc-command-based/commands.mdx", "note": "The lesson's topic and original outline come from Mantik's page of the same name; the text was rewritten for GarageDocs."},
