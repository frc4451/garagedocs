...
difficulty: beginner
duration: 15 min
description: "Elastic, the browser dashboard: installing it, sending values from robot code over NetworkTables, widgets, and interactive controls with an arm example."
---

### Put robot data on Elastic
...
**Installation:** Elastic is installed by the WPILib installer, alongside AdvantageScope. Launch it from *WPILib: Start Tool* → *Elastic* in VS Code or from `wpilib/2026/tools`. A newer WPILib release updates it; the [WPILib releases page](https://github.com/wpilibsuite/allwpilib/releases) lists them.
...
<Sources items={[
  {"source": "mantik", "path": "src/content/frc/frc-basics/elastic-basics.mdx", "note": "The lesson's topic and original outline come from Mantik's page of the same name; the text was rewritten for GarageDocs."},
  {"source": "wpilib", "path": "docs/software/dashboards/elastic.html", "note": "Elastic in the WPILib installer and docs."},
  {"url": "https://frc-elastic.gitbook.io/docs", "label": "Elastic docs", "note": "Layouts, widgets, connecting to the robot."},
  {"url": "https://github.com/Gold872/elastic-dashboard", "label": "Elastic repository", "note": "Releases."},
  {"source": "wpilib", "path": "docs/zero-to-robot/step-2/wpilib-setup.html", "note": "The installer that ships Elastic and AdvantageScope."},
  {"source": "cobra", "path": "src/main/java/frc/robot/Robot.java", "note": "What Cobra publishes for the dashboard."}
]} />

<LinkGrid links={[{"label":"Introduction to Command-Based","id":"introduction-to-command-based"},{"label":"Elastic Documentation","url":"https://frc-elastic.gitbook.io/docs"}]} title="Resources" section="frc" />
