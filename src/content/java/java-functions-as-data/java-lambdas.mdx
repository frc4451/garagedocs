...
- **The body is long.** A lambda spanning fifteen lines is harder to read than a named method. Extract it and use a [method reference](/java/fundamentals/method-references#when-a-lambda-forwards-directly).
