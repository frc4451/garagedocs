...
If the bound is large, backtracking will not finish, and the intended solution is probably [dynamic programming](/java/fundamentals/memoization-and-dynamic-programming#tabulation-the-same-thing-bottom-up) or something greedy.
