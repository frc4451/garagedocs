---
title: Backtracking
lessonId: java-algo-backtracking
section: java
...
If the bound is large, backtracking will not finish, and the intended solution is probably [dynamic programming](/java/java-algo-memoization#tabulation-the-same-thing-bottom-up) or something greedy.
...
<JavaPlayground id="java-algo-backtracking" />
