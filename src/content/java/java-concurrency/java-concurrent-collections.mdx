...
On a full bounded queue, add throws and offer returns false without inserting the item. Check that result and decide whether to retry, wait, or report that the item was not accepted.
