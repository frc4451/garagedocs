...
public class Shooter {
    ...
    public Shooter(Motor motor) {              // told, not decided
        this.motor = motor;
    }
...
public class Shooter {
    ...
    public Shooter(MotorController motor) {
        this.motor = motor;
    }

    public void spinUp() { motor.set(0.9); }
...
```java
public class FakeMotor implements MotorController {
...
<LinkGrid title="Next lesson" section="java" links={[{"label": "Command Pattern", "id": "java-command-pattern"}]} />
