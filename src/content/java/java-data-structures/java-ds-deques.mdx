...
Adding at the front costs the same as adding at the back: both are instant. That is the thing an `ArrayList` cannot do, where inserting at index 0 shifts every element.
...
<ContentTable
  ...
  rows={[
    ...
    ["<code>ArrayBlockingQueue</code>", "Passing work between threads safely"]
  ]}
/>
...
<JavaPlayground id="java-ds-deques" />
